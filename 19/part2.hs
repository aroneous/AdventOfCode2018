...
main = do
    ...
    let l = lines contents
        ...
        finalState = runProgram program pcReg 0 $ S.fromList [1,0,0,0,0,0]
    --print $ samples !! 0
    --print $ canBeThree
...
-- Note: inspection shows that program is finding the sum of factors of a large number: 10551330. The program would not
-- complete in a reasonable time, so the sum was found by other means: 28137600
